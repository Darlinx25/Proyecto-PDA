...
<html lang="es">
    <head>
        ...
        <title>Marcar Propuesta Favorita</title>
    ...
    <body class="bg-light d-flex justify-content-center align-items-center min-vh-100 py-2" id="cuerpo">
        ...
        <form action="/marcar-propuesta-favorita" method="post" class="card p-5 shadow" id="formulario">

            <h2 class="text-center mb-4">Marcar propuesta como favorita</h2>
            ...
            <button type="submit" class="btn btn-success w-100 mb-3">Agregar propuesta a favoritos</button>

        </form>

        <script src="${pageContext.request.contextPath}/resources/js/marcarPropuestaFavorita.js"></script>
