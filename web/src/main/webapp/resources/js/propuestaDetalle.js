...
function cargarPropuestaFavorita() {
    const select = document.getElementById("propuestaFavoritas");
    const valor = select.value;

    if (!valor) return;

    console.log(valor);
    const container = document.getElementById("contenedorPropuestaFavoritas");
